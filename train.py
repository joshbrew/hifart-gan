...
def main():
    ...
    parser.add_argument('--input_training_file', default='drive/MyDrive/hifigan/dataset/train_files.txt')
    parser.add_argument('--input_validation_file', default='drive/MyDrive/hifigan/dataset/validation_files.txt')
